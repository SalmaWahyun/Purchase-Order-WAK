...
<head>
    ...
    <title>Detail Riwayat - Purchase Order</title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <!-- Detail Riwayat Section -->
                                    <div id="detailSection">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <h4 class="card-title">Detail Riwayat #{{ $riwayat->id_pesanan }}</h4>
                                            <div>
                                                ...
                                                <a href="{{ route('riwayat.index') }}" class="btn btn-secondary" id="btnKembali">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card shadow-sm h-100">
                                                    <div class="card-header bg-primary text-white">
                                                        <h5 class="mb-0">Informasi Riwayat</h5>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <p class="form-control">{{ date('d/m/Y H:i', strtotime($riwayat->tanggal_pesan)) }}</p>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <p class="form-control">{{ date('d/m/Y H:i', strtotime($riwayat->tanggal_kirim)) }}</p>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <p class="form-control">{{ ucfirst($riwayat->status) }}</p>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <p class="form-control">{{ $riwayat->nama_konsumen }}</p>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <p class="form-control">{{ $riwayat->nama_suplier }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="previewInvoiceSection" style="display: none;">
                                        <div class="container">
                                            <div class="d-flex justify-content-between mb-4">
                                                <button onclick="hidePreview()" class="btn btn-secondary no-print">
                                                    <i class="mdi mdi-arrow-left"></i> Kembali
                                                </button>
                                            ...
                                            <div class="invoice-header">
                                                <h2>CV. WAK PUTRA JAYA</h2>
                                                    ...
                                                    <p>No. Invoice: WAK/{{ date('y', strtotime($riwayat->tanggal_pesan)) }}{{ date('m', strtotime($riwayat->tanggal_pesan)) }}{{ str_pad($riwayat->id_pesanan, 2, '0', STR_PAD_LEFT) }}</p>
                                                </div>
                                                ...
                                                <div class="row invoice-info">
                                                    <div class="col-sm-4 invoice-info-box">
                                                        ...
                                                        <p>{{ $riwayat->nama_suplier }}</p>
                                                    </div>
                                                    <div class="col-sm-4 invoice-info-box">
                                                        <h5>Kepada:</h5>
                                                        <p>{{ $riwayat->nama_konsumen }}</p>
                                                    </div>
                                                    <div class="col-sm-4 invoice-info-box">
                                                        <h5>Info Pesanan:</h5>
                                                        <p>Tanggal Pesan: {{ date('d/m/Y', strtotime($riwayat->tanggal_pesan)) }}</p>
                                                        <p>Tanggal Kirim: {{ date('d/m/Y', strtotime($riwayat->tanggal_kirim)) }}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row invoice-signature">
                                                    <div class="col-md-6 text-center">
                                                        ...
                                                        <p><strong>{{ $riwayat->nama_user }}</strong></p>
                                                    </div>
                                                    <div class="col-md-6 text-center">
                                                        <p>Diterima oleh:</p>
                                                        <br><br><br>
                                                        <p>_______________________</p>
                                                        <p><strong>{{ $riwayat->nama_konsumen }}</strong></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <div id="suratJalanPrintArea" class="surat-jalan-container">
                                                ...
                                                <h2>CV. WAK PUTRA JAYA</h2>
                                                    <p>Jl. Bengkel 9 Jaya No. 575 Ds. Gempolkerep Kec. Gedeg Kab. Mojokerto</p>
                                                    <h3 class="mt-4">INVOICE</h3>
                                                    <p>No. Invoice: SJ/{{ date('y', strtotime($riwayat->tanggal_pesan)) }}{{ date('m', strtotime($riwayat->tanggal_pesan)) }}{{ str_pad($riwayat->id_pesanan, 2, '0', STR_PAD_LEFT) }}</p>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-6">
                                                        <div class="info-box">
                                                            ...
                                                            <p>Tanggal: {{ date('d/m/Y', strtotime($riwayat->tanggal_kirim)) }}</p>
                                                            <p>No. Pesanan: {{ $riwayat->id_pesanan }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="info-box">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            @foreach($detail_riwayat as $index => $detail)
                                                            <tr>
                                                                <td>{{ $index + 1 }}</td>
                                                                <td>{{ $detail->nama_produk }}</td>
